...
/**
 * 
 * @param {number} i UTC Minute 
 * @returns UTC Minute padded with 0 in front
 */
function addzero (i) {
    if (i < 10) {
        i = "0" + i; 
...
export const aqiText = {
    ...
    3: {
        level: "Moderate",
        message: "Members of sensitive groups may experience health effects. The general public in not likely to be affected."
    },
    4: {
        level: "Poor",
